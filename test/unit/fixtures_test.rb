...
class FixturesTest < ActiveSupport::TestCase
  ...
  def test_import_layouts_ignoring
    layout = cms_layouts(:default)
    layout_path       = File.join(ComfyPress.config.fixtures_path, 'sample-site', 'layouts', 'default')
  ...
  def test_import_pages_creating
    ...
    assert_difference 'Cms::Page.count', 2 do
      ComfyPress::Fixtures.import_pages('default-site', 'sample-site')
  ...
  def test_import_pages_ignoring
    ...
    page_path         = File.join(ComfyPress.config.fixtures_path, 'sample-site', 'pages', 'index')
  ...
  def test_import_snippets_creating
    ...
    assert_difference 'Cms::Snippet.count' do
      ComfyPress::Fixtures.import_snippets('default-site', 'sample-site')
  ...
  def test_import_snippets_ignoring
    snippet = cms_snippets(:default)
    snippet_path      = File.join(ComfyPress.config.fixtures_path, 'sample-site', 'snippets', 'default')
    ...
    assert_difference 'Cms::Layout.count', 2 do
      assert_difference 'Cms::Page.count', 2 do
        assert_difference 'Cms::Snippet.count', 1 do
          ComfyPress::Fixtures.import_all('default-site', 'sample-site')
        end
      end
    end
  end
  ...
  def test_export_layouts
    host_path = File.join(ComfyPress.config.fixtures_path, 'test-site')
    ...
    ComfyPress::Fixtures.export_layouts('default-site', 'test-site')
  ...
  def test_export_pages
    ...
    ComfyPress::Fixtures.export_pages('default-site', 'test-site')
  ...
  def test_export_snippets
    ...
    ComfyPress::Fixtures.export_snippets('default-site', 'test-site')
  ...
  def test_export_all
    host_path = File.join(ComfyPress.config.fixtures_path, 'test-site')
    ComfyPress::Fixtures.export_all('default-site', 'test-site')
    FileUtils.rm_rf(host_path)
  end

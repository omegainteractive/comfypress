...
class FieldRichTextTagTest < ActiveSupport::TestCase
  ...
  def test_initialize_tag
    assert tag = ComfyPress::Tag::FieldRichText.initialize_tag(
  ...
  def test_initialize_tag_failure
    [
      ...
      assert_nil ComfyPress::Tag::FieldRichText.initialize_tag(
  ...
  def test_content_and_render
    tag = ComfyPress::Tag::FieldRichText.initialize_tag(
      cms_pages(:default), '{{cms:field:content:rich_text}}'
    )

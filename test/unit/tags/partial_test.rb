...
class PartialTagTest < ActiveSupport::TestCase
  ...
  def test_initialize_tag
    assert tag = ComfyPress::Tag::Partial.initialize_tag(
  ...
  def test_initialize_tag_failure
    [
      ...
      assert_nil ComfyPress::Tag::Partial.initialize_tag(
  ...
  def test_content_and_render
    tag = ComfyPress::Tag::Partial.initialize_tag(
      cms_pages(:default), '{{cms:partial:path/to/partial}}'
    )
  ...
  def test_whitelisted_paths
    ComfyPress.config.allowed_partials = ['safe/path']

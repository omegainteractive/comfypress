...
class PageRichTextTagTest < ActiveSupport::TestCase
  ...
  def test_initialize_tag
    assert tag = ComfyPress::Tag::PageRichText.initialize_tag(
  ...
  def test_initialize_tag_failure
    [
      ...
      assert_nil ComfyPress::Tag::PageRichText.initialize_tag(
  ...
  def test_content_and_render
    tag = ComfyPress::Tag::PageRichText.initialize_tag(
      cms_pages(:default), '{{cms:page:content:rich_text}}'
    )
